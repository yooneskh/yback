...
type IResourceValidationFunction<T, TF extends IResourceBase> = (it: T & Partial<Omit<TF, keyof T>>, controller?: ResourceController<T, TF>) => boolean | string | Promise<boolean | string>;
